...
create table company(company_name varchar(50), city varchar(20), primary key (company_name));
create table employee(ID varchar(5), person_name varchar(10), street varchar(20), city varchar(20), primary key (ID));
create table works(ID varchar(5), company_name varchar(50), salary int, primary key (ID), foreign key (ID) references employee (ID), foreign key (company_name) references company (company_name));
...
insert into works values ('12345', 'First Bank Corporation', 11000);
insert into works values ('11111', 'Second Bank Corporation', 12000);
insert into works values ('22222', 'First Bank Corporation', 22000);
insert into works values ('33333', 'Big Bank Corporation', 200000);
insert into works values ('44444', 'Second Bank Corporation', 23000);
insert into works values ('55555', 'Big Bank Corporation', 120000);
insert into works values ('66666', 'Small Bank Corporation', 9500);
insert into works values ('77777', 'First Bank Corporation', 8000);
insert into works values ('88888', 'Second Bank Corporation', 10000);
insert into works values ('99999', 'Big Bank Corporation', 110000);
insert into works values ('00000', 'Small Bank Corporation', 11000);
insert into works values ('54321', 'Big Bank Corporation', 90000);
